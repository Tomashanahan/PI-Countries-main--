...
import { clean_country_detail,get_country_activities,delete_activity_of_country } from "../../Redux/Actions/index";
...
function CountryDetail() {
	...
	return (
		<div className="detalle">
			...
			<div className={country_activities.length > 1 ? "actividad_pais_grid" : "actividad_pais_flex"}>
				{country_activities.length > 0  && country.name !== undefined && (
